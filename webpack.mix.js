...
mix.webpackConfig({
  ...
  resolve: {
    alias: {
      // Map @form-validation imports to the local UMD folder (prebuilt bundles)
      '@form-validation': path.resolve(__dirname, 'resources/assets/vendor/libs/@form-validation/umd'),
      // Prefer the published quill package entry which provides correct exports
...
/*
 ...
 |--------------------------------------------------------------------------
 */
// Copy all CSS files (preserving folder structure)
mix.copyDirectory('resources/assets/css', 'public/css');

// Copy all JS files (preserving folder structure)
mix.copyDirectory('resources/assets/js2', 'public/js');

// Copy all images (preserving folder structure)
mix.copyDirectory('resources/assets/images', 'public/images');

// Copy all fonts (preserving folder structure)
mix.copyDirectory('resources/assets/fonts', 'public/fonts');
        mix.copy('node_modules/@fortawesome/fontawesome-free/css/fontawesome.min.css', 'public/assets/vendor/fonts/fontawesome.css');
...
// compile the tabler scss (if not already compiled by the glob rules)
// mix.sass('resources/assets/vendor/fonts/tabler-icons.scss', 'public/assets/vendor/fonts/tabler-icons.css');
